    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                errmsg = '';
                if (!n)
                    errmsg += 'Please provide filename. ';
                ...
                if (!errmsg) return [3 /*break*/, 1];
                res.status(400).send(errmsg);
                return [3 /*break*/, 3];
            case 1: return [4 /*yield*/, (w && h
                    ? getImage_1.default(n, w, h)
                    : w
                        ? getImage_1.default(n, w)
                        : h
                            ? getImage_1.default(n, 0, h)
                            : getImage_1.default(n))
                    .catch(function () {
                    img_1 = undefined;
                })
                    .then()];
